...
public class LegacyWindow extends BaseWindow implements ImageReader.OnImageAvailableListener, Camera.PreviewCallback {
    ...
    private final TextureView.SurfaceTextureListener surfaceTextureListener =
            new TextureView.SurfaceTextureListener() {
                ...
                public void onSurfaceTextureAvailable(
                    ...
                    camera.setPreviewCallbackWithBuffer(LegacyWindow.this);
    ...
    Thread HILL_CLIMP_ACEL_GG = new Thread() {
        public void run() {
            while (true) {
                downTime = SystemClock.uptimeMillis();
                eventTime = SystemClock.uptimeMillis();
                m_Instrumentation.sendPointerSync(MotionEvent.obtain(downTime, eventTime, MotionEvent.ACTION_UP, 2271, 1179, 0));
    ...
    Thread HILL_CLIMP_BRAK_G = new Thread() {
        public void run() {
            while (true) {
                downTime = SystemClock.uptimeMillis();
                eventTime = SystemClock.uptimeMillis();
                m_Instrumentation.sendPointerSync(MotionEvent.obtain(downTime, eventTime, MotionEvent.ACTION_DOWN, 298, 1196, 0));
    ...
    Thread HILL_CLIMP_BRAK_GG = new Thread() {
        public void run() {
            while (true) {
                downTime = SystemClock.uptimeMillis();
                eventTime = SystemClock.uptimeMillis();
                m_Instrumentation.sendPointerSync(MotionEvent.obtain(downTime, eventTime, MotionEvent.ACTION_UP, 298, 1196, 0));
                    ...
                    public void run() {
                        ...
                        Thread RIGHT_SWIPE = new Thread() {
                            public void run() {
                                ...
                                // event time MUST be retrieved only by this way!
                                long eventTime = SystemClock.uptimeMillis();
                                m_Instrumentation.sendPointerSync(MotionEvent.obtain(downTime, eventTime, MotionEvent.ACTION_DOWN, 240, 1440, 0));
                                m_Instrumentation.sendPointerSync(MotionEvent.obtain(downTime, eventTime, MotionEvent.ACTION_MOVE, 450, 1440, 0));
                                m_Instrumentation.sendPointerSync(MotionEvent.obtain(downTime, eventTime, MotionEvent.ACTION_MOVE, 590, 1440, 0));
                                m_Instrumentation.sendPointerSync(MotionEvent.obtain(downTime, eventTime, MotionEvent.ACTION_MOVE, 1000, 1440, 0));
                                m_Instrumentation.sendPointerSync(MotionEvent.obtain(downTime, eventTime, MotionEvent.ACTION_UP, 1000, 1440, 0));
                        ...
                        Thread LEFT_SWIPE = new Thread() {
                            public void run() {
                                ...
                                // event time MUST be retrieved only by this way!
                                long eventTime = SystemClock.uptimeMillis();
                                m_Instrumentation.sendPointerSync(MotionEvent.obtain(downTime, eventTime, MotionEvent.ACTION_DOWN, 1000, 1440, 0));
                                m_Instrumentation.sendPointerSync(MotionEvent.obtain(downTime, eventTime, MotionEvent.ACTION_MOVE, 590, 1440, 0));
                                m_Instrumentation.sendPointerSync(MotionEvent.obtain(downTime, eventTime, MotionEvent.ACTION_MOVE, 450, 1440, 0));
                                m_Instrumentation.sendPointerSync(MotionEvent.obtain(downTime, eventTime, MotionEvent.ACTION_MOVE, 240, 1440, 0));
                                m_Instrumentation.sendPointerSync(MotionEvent.obtain(downTime, eventTime, MotionEvent.ACTION_UP, 240, 1440, 0));
