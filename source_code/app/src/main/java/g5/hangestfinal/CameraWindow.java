...
public class CameraWindow extends BaseWindow implements ImageReader.OnImageAvailableListener, Camera.PreviewCallback {
...
//        final Activity activity = WindowManager;
//        if (activity != null) {
...
//                    .show(getFragmentManager(), FRAGMENT_DIALOG);
        ...
        CameraWindow.this.onPreviewSizeChosen(getDesiredPreviewFrameSize(), sensorOrientation);
    }
    ...
    private void createCameraPreviewSession() {
        try {
            ...
            previewReader.setOnImageAvailableListener(CameraWindow.this, backgroundHandler);
    ...
    private void configureTransform(final int viewWidth, final int viewHeight) {
        if (null == textureView || null == getDesiredPreviewFrameSize() || null == getApplicationContext()) {
            return;
        }
...
//            }catch(InterruptedException e){}
    ...
    public void onPreviewSizeChosen(final Size size, final int rotation) {
        ...
        LOGGER.i("Sensor orientation: %d, Screen orientation: %d", rotation, 0);

        sensorOrientation = rotation + 0;
